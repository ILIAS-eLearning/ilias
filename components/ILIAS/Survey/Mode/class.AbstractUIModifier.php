...
abstract class AbstractUIModifier implements UIModifier
{
    ...
    public function getDetailPanels(
        ...
        $panel_qst_card = $ui_factory->panel()->sub($title, $ui_factory->legacy()->legacyContent($svy_text))
        ...
        $panels[] = $ui_factory->panel()->sub("", $ui_factory->legacy()->legacyContent($a_tpl->get()));
        return $panels;
    }
    ...
    protected function getPanelCard(
        ...
        return $ui_factory->card()
                          ...
                          ->withSections(
                              array($ui_factory->legacy()->legacyContent($card_table_tpl->get()))
                          );
    }
}
