...
class Notification extends Item implements INotification, IJavaScriptBindable
{
    ...
    protected ?LegacyContent $additional_content = null;
     ...
     * @inheritdoc
     */
    public function withAdditionalContent(LegacyContent $additional_content): INotification
    {
        $clone = clone $this;
     ...
     * @inheritdoc
     */
    public function getAdditionalContent(): ?LegacyContent
    {
