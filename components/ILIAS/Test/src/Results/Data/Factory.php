    ...
    private function buildAttemptResults(
        ...
        foreach ($results as $idx => $qresult) {
            ...
            if ($show_question_only) {
                $usr_solution = $this->ui_renderer->render($this->ui_factory->legacy()->legacyContent('<div class="ilc_question_Standard">' . $usr_solution . '</div>'));
                $best_solution = $this->ui_renderer->render($this->ui_factory->legacy()->legacyContent('<div class="ilc_question_Standard">' . $best_solution . '</div>'));
            }
