...
class ilExerciseManagementGUI
{
    ...
    public function getReportPanel(array $a_data): string
    {
        ...
        $main_panel = $this->ui_factory->panel()->sub($a_data['uname'], $this->ui_factory->legacy()->legacyContent($a_data['utext']))
            ->withFurtherInformation($this->ui_factory->card()->standard($this->lng->txt('text_assignment'))->withSections(array($this->ui_factory->legacy()->legacyContent($card_tpl->get()))))->withActions($actions_dropdown);
        ...
        $feedback_panel = $this->ui_factory->panel()->sub("", $this->ui_factory->legacy()->legacyContent($feedback_tpl->get()));
    ...
    public function getEvaluationModal(
        ...
        return  $this->ui_factory->modal()->roundtrip(strtoupper($this->lng->txt("grade_evaluate")), $this->ui_factory->legacy()->legacyContent($modal_tpl->get()))->withActionButtons([$submit_btn]);
    }
    ...
    protected function initIndividualDeadlineModal(): string
    {
        ...
        $modal = $this->ui_factory->modal()->roundtrip(
            ...
            $this->ui_factory->legacy()->legacyContent('<div id="ilExcIDlBody"></div>')
        );
