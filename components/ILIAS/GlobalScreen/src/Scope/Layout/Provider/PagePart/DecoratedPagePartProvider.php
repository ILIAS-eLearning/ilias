...
class DecoratedPagePartProvider implements PagePartProvider
{
    ...
    private function getDecoratedOrOriginal(string $purpose, LegacyContent|null|MetaBar|MainBar|Breadcrumbs|Image|string|Footer|TContainer $original)
    {
    ...
    {
        return $this->getDecoratedOrOriginal(LegacyContent::class, $this->original->getContent());
    }
