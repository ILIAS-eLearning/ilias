...
abstract class AbstractBaseItem implements isItem, isDecorateable
{
    ...
    protected ?LegacyContent $non_available_reason = null;
    ...
    public function getNonAvailableReason(): LegacyContent
    {
        ...
        return $this->non_available_reason instanceof Legacy ? $this->non_available_reason : $DIC->ui()->factory()->legacy()->legacyContent("");
    }
